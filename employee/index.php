  ...
  <div class="wrapper">
            ...
            <div class="col-lg-12">
              <div class="card-body p-md-5">
                <div class="text-center">
                  <img src="<?= $config['logo'] ?>" width="130" height="130" alt="">
                  <h3 style="color:#1fcecb" class="mt-4 font-weight-bold">Welcome Back Employee</h3>
    ...
    box-shadow: #1fcecb;}" name="email" id="email" class="form-control" placeholder="Enter your email address">
                  ...
                  <div class="btn-group mt-3 w-100">
                    ...
                    <button type="button" style="background-color:#1fcecb;" class="btn btn-secondary"><i class="lni lni-arrow-right"></i>
                    </button>
                  </div>
                </form>
